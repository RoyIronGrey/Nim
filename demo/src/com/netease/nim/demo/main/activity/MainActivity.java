...
import com.netease.nim.demo.utils.BlockDetectByPrinter;
import com.netease.nim.demo.utils.ConsistentService;
...
public class MainActivity extends UI {
    ...
    protected void onResume() {
        Intent startServiceIntent = new Intent(MainActivity.this, ConsistentService.class);
    ...
    public void onBackPressed() {
        if (mainFragment != null) {
            if (mainFragment.onBackPressed()) {
                ...
                Intent stopServiceIntent = new Intent(MainActivity.this, ConsistentService.class);
